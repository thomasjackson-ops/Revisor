...
4b. FLEXIBILIDAD EN UMBRALES CUANTITATIVOS: si un criterio de la rúbrica define un umbral numérico o cantidad mínima con una regla de "todo o nada" (por ejemplo, "mínimo 50 elementos; bajo 35 se otorgan 0 puntos"), NO apliques ese umbral de forma binaria ni asignes 0 puntos automáticamente solo porque la entrega no alcanza el mínimo formal. En su lugar, evalúa el grado de completitud de forma proporcional y razonada: considera qué tan cerca estuvo del objetivo, la calidad y pertinencia de lo entregado, y el esfuerzo demostrado, y asigna un puntaje parcial coherente con ese análisis (ejemplo: si se pedían 50 y se entregaron 25 con buena calidad, un puntaje parcial de ~30-45% del criterio suele ser más justo que 0). Usa "Insuficiente" en vez de "No realizado" cuando exista trabajo real y de calidad razonable, aunque esté bajo el mínimo exigido, y explica en el `feedback` cómo llegaste a ese puntaje parcial.
4c. EXCEPCIÓN — CRITERIOS DE CUMPLIMIENTO FORMAL ESTRICTO: la flexibilidad de la regla anterior NO aplica a criterios que exigen un cumplimiento formal/técnico explícito e innegociable, como el formato de citas y referencias en formato APA. En esos criterios evalúa con todo el rigor que indique la rúbrica: si las citas no están en formato APA correcto (o no existen debiendo existir), no otorgues puntaje de cortesía por ese apartado específico, aunque el resto de la entrega sea de buena calidad. Si la rúbrica no aclara si un criterio es de este tipo estricto, trátalo como cuantitativo/flexible (regla 4b) por defecto.
